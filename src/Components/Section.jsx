...
function Section() {
  const data = [
    {
      ...
      img: "./assets/videoimg/sniper1.webp 5x",
      texth2: "BARLOG",
      texth3: "DESIGNER",
    ...
    },
    {
      num: "02",
      nump: "QUEST",
      img: "./assets/videoimg/dark.webp 5x",
  ...
  const card = [
    {
      img: "./assets/videoimg/robo.webp 5x",
      name: "ZORD",
      p: "From Master League",
    },
    {
      img: "./assets/videoimg/magic.webp 5x",
      name: "THE SCARLET SORCERER",
      p: "From Flagship Mountain",
    },
    {
      img: "./assets/videoimg/girl.webp 5x",
      name: "KATANNA",
      p: "From Battle of the Braves",
    },
  ];
  const video = [
    "./assets/videoimg/file1.mp4",
    "./assets/videoimg/file2.mp4",
    "./assets/videoimg/file3.mp4",
  ];
